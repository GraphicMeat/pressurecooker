...
3. **Check for an existing global directory:**
   ...
   ls -d ~/.config/pressurecooker/worktrees/$project 2>/dev/null
   ```
   If found, use it.
...
Global directories (`~/.config/pressurecooker/worktrees/`) need no verification.
...
# For global: path="~/.config/pressurecooker/worktrees/$project/$BRANCH_NAME"
